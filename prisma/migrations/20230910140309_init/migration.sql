...
CREATE TABLE "students" (
    ...
    "academicDepartId" TEXT NOT NULL,
    "academicFacultyId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academicDepartId_fkey" FOREIGN KEY ("academicDepartId") REFERENCES "academic_departments"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
